     ...
     <div id="table" class="mt10">
        <div class="box span10 oh">
              ...
              <thead>
                ...
                <tbody id="table_body">
               <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$login): $mod = ($i % 2 );++$i;?><tr class="tr">
		  		<td class="td_center"><input type="checkbox"><?php echo ($i); ?></td>
		  		<td class="td_center"><?php echo ($login["username"]); ?></td>
		  		<td class="td_center"><?php echo ($login["logintime"]); ?></td>
		  		<td class="td_center"><?php echo ($login["loginip"]); ?></td>
		  		<td class="td_center"><?php echo ($login["notes"]); ?></td>
...
$(function(){
	...
	kkpager.generPageHtml({
		...
		click : function(n){
			this.selectPage(n);
			window.location="__ROOT__/admin.php/Login/loginCount/p/"+n;
